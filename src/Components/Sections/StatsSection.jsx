...
const StatsSection = () => {
  return (
    <section className="relative py-12 px-4 md:px-6 -mt-16 mb-20 z-20">
      <div className="container mx-auto max-w-6xl">
        
        {/* 🟢 The "Clay" Container */}
        <div className="clay-card bg-bg-surface/80 backdrop-blur-xl border border-white/20 p-8 md:p-12 shadow-2xl relative overflow-hidden rounded-[2.5rem]">
